...
static const char dmenufont[]       = "hacknerdfont:size=20";
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } },
        ...
        /*{ MODKEY,                       XK_F1,    spawn,         SHCMD("pactl set-sink-mute @DEFAULT_SINK@ togglr) },
	  ...
	  { MODKEY,                       XK_F5,    spawn,         SHCMD("brightnessctl set 5%-") },
          ...
          SL Status Bar
          pactl get-sink-volume @DEFAULT@ vedere il volume
